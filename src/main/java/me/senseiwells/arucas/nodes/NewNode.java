...
public class NewNode extends Node {
	...
	public Value<?> visit(Context context) throws CodeError, ThrowValue {
		...
		ArucasClassDefinition definition = context.getClassDefinition(this.className.content);
		if (definition == null) {
			throw new RuntimeError("The class '%s' does not exist", this.syntaxPosition, context);
		}
		...
		return definition.createNewDefinition(context, parameters);
	}
}
